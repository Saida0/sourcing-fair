...
import { Mail, Phone, MapPin, ArrowRight, Check, Download } from "lucide-react";
        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
          <div className="col-span-2">
            <Link to="/" className="inline-block">
              {/* Navy wordmark needs a light surface to read on this navy
                  footer, hence the white chip. */}
              <span className="inline-flex rounded-[10px] bg-white px-3.5 py-2">
                <img
                  src={logo}
            ...
            <div className="mt-6 flex flex-col gap-2.5 text-sm text-white/70">
              ...
              <a
                ...
                download
                className="mt-2 flex items-center gap-2 font-semibold text-sf-brass-light hover:text-white"
              >
                <Download size={15} /> Download company profile (PDF)
              </a>
            </div>
          </div>
